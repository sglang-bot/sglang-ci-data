...
# CI-sized sampling params. Verified on a single H200 with fp8-cast +
# inference_mode. Pass --skip-v2a-cross-attn-for-video-gt to reproduce the
# older legacy GT behavior.
