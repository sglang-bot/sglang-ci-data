...
*Generated: Apr 23 | Commit: `c689f77`*

> [!WARNING]
> **Performance Regression Detected**
>
> - **ltx2_twostage_t2v** (sglang): 15.32s -> 16.75s (+9.3%)
...
| FLUX.1-dev | ✅ | **6.60** |
| FLUX.2-dev | ✅ | **22.62** |
| Qwen-Image-2512 | ✅ | **13.03** |
| Qwen-Image-Edit-2511 | ✅ | **23.68** |
| Z-Image-Turbo | ✅ | **0.88** |
...
| Apr 04 | `c84f085` | 6.86 | 22.87 | 13.16 | 23.95 | 0.93 | 210.88 | 62.21 | 14.89 | N/A | 206.55 | -- |
...
> - ltx2_twostage_t2v: SGLang regression +10.1% vs 3-run avg (16.75s vs 15.21s)
