...
*Generated: Apr 08 | Commit: `dd73e9a`*
...
| Z-Image-Turbo | ✅ | **0.89** |
| Wan2.2-T2V-A14B-Diffusers | ✅ | **210.25** |
| Wan2.2-TI2V-5B-Diffusers | ✅ | **62.20** |
| LTX-2 | ⚠️ | **15.24** |
| Wan2.2-I2V-A14B-Diffusers | ✅ | **206.65** |
...
| Mar 29 | `5958f9d` | 6.70 | 22.86 | 13.19 | 29.74 | 0.93 | 16.31 | 62.18 | N/A | 10.04 | -- |

> [!CAUTION]
> **Action Required — Performance Alert**
>
> The following cases need attention:
> - ltx2_twostage_t2v: SGLang regression +5.6% vs 3-run avg (15.24s vs 14.43s)
